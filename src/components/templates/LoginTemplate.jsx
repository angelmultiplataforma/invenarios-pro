...
import { Btnsave, v, useAuthStore, InputText, FooterLogin } from "../../index";/* Puede que haya que añadir registrarAdmin */
import { Device } from "../../styles/breackpoints";
import { useContext, useState, useEffect} from "react"; //Se ha añadido el import useEffect
...
export function LoginTemplate() {
  ...
  // Ejecutar setTheme después del primer render
  // ❗ Explicación: React no permite actualizar estado o contexto durante el render,
  //   así que movemos este llamado a useEffect para evitar el error:
